package co.restifo.inquisitiv.ui;
...
import co.restifo.inquisitiv.R;
        ...
        if (textureView != null) {
            ...
            textureView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    // TODO: Show picture take animation, submit pic to server, get the data back, and show the results
                    return true;
                }
            });
        }
